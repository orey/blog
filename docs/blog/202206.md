...
Fighting Fantasy est le système de jeu des _Livres dont cous êtes le héros_. En 1984, Steve Jackson et Ian Livingstone transforment le système de jeu des livres solo en JDR très simple.
...
(*) Extensions que l'on trouve à la fois dans _Advanced Fighting Fantasy_ de 1989 et dans _Troika!_.
...
Comme je n'ai jamais beaucoup joué à D&D, je n'avais quasiment rien en stock, à part la boîte de base de D&D en français de 1982 de Moldvay, que j'ai donnée à mon frère je crois.

![d&dmoldvay](../images/d&dmoldvay.png)

Donc, il y a deux ans, je n'avais rien. En me remettant un peu dans le coup, j'ai découvert la vague OSR et la fameuse version D&D 3e et 3.5e. En cherchant un peu, j'ai trouvé les 3 bouquins d'occase. Le jeu est quand même bien touffu.

Puis j'ai repris les investigations sur D&D : d'abord sur D&D 0e, puis sur AD&D 1e où j'ai profité d'une promotion dur DmsGuild pour acheter les 3 bouquins en reprint. En plus de l'édition 3.5, j'ai lu l'édition gratuite de D&D 5e Basic Rules que j'ai fait imprimer chez Lulu (première tentative, pas top au niveau rendu).

Voilà. Pour l'instant, la première édition d'AD&D reste ma favorite, même si le Manuel du Maître est quand même un peu en mode bazar. J'avoue que j'aime bien la logique didactique de Gary Gygax, ainsi que certains parti-pris qu'il avait sur le JDR.

Pour la 4e, c'est vraiment une tentative. Il va me falloir un certain temps pour lire le livre et me faire une idée. Surtout que j'ai déjà _Worlds Without Number_ à lire avant...
