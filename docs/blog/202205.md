...
Voir la page sur la [comparaison des systèmes de jeu D6](../pages/D6-systems.md).

J'ai retravaillé les PDFs originaux trouvés sur [les sites de fans US](https://rendedpress.blogspot.com/2015/11/ghostbusters-rpg-legit-downloads-gbfans.html) pour avoir tout en un volume (scenarii inclus).
