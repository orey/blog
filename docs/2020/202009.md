...
![Gustav Mahler](mahler.jpg)

For sure, there is no link between D&D and Mahler, except that they are various manifestations of the human culture.

The fact is the digging into D&D history is, for me, as the digging into my old CDs of the Mahler symphonies.

I stopped listening to Mahler several years ago when I faced many personal troubles. In a certain way, the sadness of the 9th symphony was talking to me, doing echo to my own pain.

Even if role-playing is much older than Mahler symphonies, synchronicity seems to be there, as Jung would have say. Another Gustav...

I created a [repo](https://github.com/orey/srd-3.5) to host the D&D 3.5 original texts, that I found in the [Wayback Machine](https://archive.org) and I have been struggling yesterday with the conversion of HTML to Markdown, problem for which I found a not-so-bad solution. The idea would be to publish the rough material in a browse-able way in order to progressively being able to integrate elements into programs.

Meanwhile, I am rediscovering the versions of the Mahler symphonies I have on CDs, and compare with the versions I found on Spotify. More soon.
