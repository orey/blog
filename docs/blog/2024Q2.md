...
Cerise sur le gâteau, le joueur peut refuser l'intrusion en perdant un point d'expérience. Monte indique que c'est peu probable parce que les joueurs ne veulent sans doute pas perdre leurs points. Et donc quoi ? Qu'est-ce qui se passe ?

Parce que si le jeu était narrativiste, ce serait le joueur qui raconterait comment se déroulent les événements. Mais là, non.
...
Oui, mais on peut aussi le faire avec un malus circonstanciel qui justifie que l'action ne soit pas automatique.
...
Le méta-gaming n'est vraiment pas mon truc.
